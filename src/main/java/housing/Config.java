...
public class Config {
    ...
    public boolean recordTotalDebt;                     // True to write individual household housing net wealth data (after market clearing)
    ...
    public boolean recordConsumption;                   // True to write individual household consumption data
    ...
    double DOWNPAYMENT_BTL_SCALE;           // Scale parameter for the log-normal distribution of downpayments by buy-to-let investors
    double DOWNPAYMENT_BTL_SHAPE;           // Shape parameter for the log-normal distribution of downpayments by buy-to-let investors
    ...
    double BTL_ALTERNATIVE_RETURN;              // Expected return on alternative (non-BTL) investments
